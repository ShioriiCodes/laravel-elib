...
<body>
    ...
    <main>
        ...
        <section class="additional-content">
            <p style="color: black;">Embarking on a journey to the world of knowledge...</p>
            <img src="/image/psu.jpg" alt="Road" style="display: block; margin: 0 auto; margin-bottom: 20px;">
        </section>
    </main>
