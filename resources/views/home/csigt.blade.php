<x-app-layout   >
    ...
    <head>
        ...
        <title>Computer science, information & general technology</title>
            ...
            <div class="container">
                ...
                <div class="catalog">
                    <div class="catalog-header">
                        <h2>Computer science, information & general technology</h2>
                            <div class="search">
                    ...
                    <div class="books-grid">
                        <div class="book-item">                    
                            <img src="{{ asset('image1/ComSci.jpg') }}" alt="Book Cover">
