            ...
            <div class="container">
                ...
                <div class="catalog">
                    ...
                    <div class="books-grid">
                        <div class="book-item">                    
                            <img src="{{ asset('image1/art.jpg') }}" alt="Book Cover">
                            <h3>Arts Color with me</h3>
                            <p>by John Doe</p><br>
                        ...
                        <div class="book-item">                    
                            <img src="{{ asset('image1/recreation.jpg') }}" alt="Book Cover">
                            <h3>Recreateional Activities</h3>
                            <p>by John Doe</p><br>
                            <p>Here is a description of the book.</p>
                                <button id="download-btn" class="download-button">
                                    <ion-icon name="arrow-down-outline" class="download-icon"></ion-icon>
