            ...
            <div class="container">
                ...
                <div class="catalog">
                    ...
                    <div class="books-grid">
                        <div class="book-item">                    
                            <img src="{{ asset('image1/course1.jpg') }}" alt="Book Cover">
                            <h3>Learning Java</h3>
                            <p>by John Doe</p><br>
                        ...
                        <div class="book-item">                    
                            <img src="{{ asset('image1/course2.jpg') }}" alt="Book Cover">
                            <h3>Mastering UI/UX Design</h3>
                            <p>by John Doe</p><br>
                            <p>Here is a description of the book.</p>
                                <button id="download-btn" class="download-button">
                                    <ion-icon name="arrow-down-outline" class="download-icon"></ion-icon>
